...
$conn = new XMPPHP_BOSH('im.hazime.org', 5280, 'kurari@im.hazime.org', 'deganjue', 'xmpphp', 'im.hazime.org', $printlog=true, $loglevel=XMPPHP_Log::LEVEL_INFO);
$conn->autoSubscribe();
...
try {
	...
	$conn->connect('http://im.hazime.org:5280/xmpp-httpbind', 1, true);
	#while(true) {
